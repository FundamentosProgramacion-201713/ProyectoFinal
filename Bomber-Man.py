...
def dibujarCajas(ventana, btnCajas):
...
def dibujarJuego(ventana, imagenRick, xRick, yRick, imagenMorty, xMorty, yMorty, btnVidasMorty, btnVidasRick, btnPausa,vidasRick, vidasMorty, puntajeRick, puntajeMorty, btnCajas):
    dibujarVidasMorty(ventana,btnVidasMorty)
    dibujarVidasRick(ventana, btnVidasRick)
    dibujarCajas(ventana, btnCajas)
        ...
        for evento in pygame.event.get():
            ...
            if evento.type == pygame.QUIT:  # El usuario hizo click en el botón de salir
                ...
                if estado == "instrucciones":
                    ...
                    dibujarJuego(ventana, imagenRick, xRick, yRick, imagenMorty, xMorty, yMorty, btnVidasMorty, btnVidasRick, btnPausa,vidasRick, vidasMorty, puntajeRick, puntajeMorty,btnCajas)
                if estado == "jugando":
                    if mover == True:
                        if vidasRick>0:
                            # MOVIMIENTOS RICK
        ...
        if estado == "menu": # MENÚ PRINCIPAL
            ...
            if bombaRick == True:
                if timerR<30:
                    ...
                    timerR = 0
#
        #for h in range(len(cajasX)):
        #    coordenada = str(cajasX[h]) +"&"+ str(cajasY[h])
        #    if coordenada not in pruebaCajas:
        #        pruebaCajas.append(coordenada)
